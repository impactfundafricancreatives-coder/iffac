...
export function Footer() {
  return (
    <>
      <style>{`
        .footer-logo:hover  { color: #EA6B0E !important; }
        .footer-link:hover  { color: #EA6B0E !important; }
        .footer-legal:hover { color: #FAFAFA !important; }
      `}</style>

      <footer style={{ background: "#1C1C1C", borderTop: "1px solid rgba(234,107,14,0.25)" }}>
        ...
        <div style={{ borderBottom: "1px solid rgba(255,255,255,0.1)" }}
          ...
          <div className="max-w-[1440px] mx-auto flex flex-col lg:flex-row lg:items-center gap-10 lg:gap-24">
            <div className="lg:flex-1">
              <p style={{ color: "#EA6B0E" }} className="text-xs font-bold tracking-[0.2em] uppercase mb-4">
                The IFFAC Journal
              </p>
              <p className="font-display font-medium leading-snug"
                style={{ color: "#FAFAFA", fontSize: "clamp(1.5rem,2.5vw,2.2rem)" }}>
            ...
            <div className="col-span-2 md:col-span-1">
              <Link href="/" className="footer-logo flex items-center gap-2 mb-4 group transition-opacity hover:opacity-80">
                ...
                <div className="flex flex-col">
                  <span className="font-display font-bold leading-none" style={{ color: "#FAFAFA", fontSize: "1.4rem" }}>
                    IFFAC
                  </span>
                  <span className="text-[8px] font-bold tracking-[0.15em] uppercase leading-tight mt-0.5" style={{ color: "#888888" }}>
                    Impact Fund for African Creatives
                  </span>
                </div>
              </Link>
              <p style={{ color: "#AAAAAA" }} className="text-sm leading-relaxed mb-5 max-w-[200px]">
                Africa&apos;s first patient-capital platform for the creative economy.
              </p>
              <div className="space-y-0.5">
                <p style={{ color: "#888888" }} className="text-xs">Accra, Ghana</p>
                <p style={{ color: "#888888" }} className="text-xs">Luxembourg</p>
              </div>
            </div>
