    ...
    <div className="bg-[#FAFAFA]">
      ...
      <section className="pt-32 pb-16 md:pt-40 md:pb-20 bg-[#1C1C1C] px-6 md:px-16 lg:px-24">
        <div className="max-w-7xl mx-auto">
          <p className="text-[#EA6B0E] text-xs font-bold tracking-[0.2em] uppercase mb-6">Contact</p>
      ...
      <section className="py-16 px-6 md:px-16 lg:px-24 border-b border-[#888888]/20">
        <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-px bg-[#888888]/20">
          {routes.map((r) => (
            <div key={r.tag} className="bg-[#FAFAFA] p-8">
              <p className="text-[#EA6B0E] text-xs font-bold tracking-[0.15em] uppercase mb-4">{r.tag}</p>
              <p className="text-[#444444] text-sm leading-relaxed mb-5">{r.desc}</p>
              <a
                href={`mailto:${r.email}`}
                className="text-[#1C1C1C] text-sm font-bold hover:text-[#1F3A8A] transition-colors underline underline-offset-2"
              >
                {r.email}
              </a>
            </div>
      ...
      <section className="py-20 md:py-28 px-6 md:px-16 lg:px-24">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16">
          <div>
            <p className="text-[#FFC200] text-xs font-bold tracking-[0.2em] uppercase mb-5">General Enquiry</p>
            ...
            <div className="space-y-3">
              <div>
                <p className="text-[#888888] text-xs font-bold uppercase tracking-wide mb-1">Accra, Ghana</p>
                <p className="text-[#1C1C1C] text-sm">West Africa headquarters</p>
              </div>
              <div>
                <p className="text-[#888888] text-xs font-bold uppercase tracking-wide mb-1">Luxembourg</p>
                <p className="text-[#1C1C1C] text-sm">Fund domicile & European office</p>
              </div>
            </div>
          </div>
          <ContactForm />
